...
def calculate_score(hand):
    ...
    # Om poängen överstiger 21 och det finns ess, minska essets värde till 1
...
while True:
    ...
    # Om spelaren har valt att stanna
    if not is_playing:
        ...
        if dealer_score > 21: 
            ...
            player_money += 10  # Vinst för spelaren
    ...
    print(f"You have ${player_money} left after this round.")
